...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productsData = {
        ...
        /* ---- Jars ---- */
        'clean-jar': {
            id: 'clean-jar', name: 'Clean Jar', price: 30,
            ...
            sizes: [
                { label: 'Small', capacity: '230g', price: 30, img: '../Assets/more product/jars/classic_jar_small.png', hoverImg: '../Assets/more product/jars/classic_jar_small_candle.png' },
                { label: 'Large', capacity: '420g', price: 45, img: '../Assets/more product/jars/classic_jar_big.png',   hoverImg: '../Assets/more product/jars/classic_jar_big_candle.png' },
            ],
        },

        'enchanted-jar': {
            id: 'enchanted-jar', name: 'Enchanted Jar', price: 30, bestSeller: true,
            category: 'jars', categoryLabel: 'Jar',
            ...
            sizes: [
                { label: 'Small', capacity: '230g', price: 30, img: '../Assets/more product/jars/vintage_jar_small.png', hoverImg: '../Assets/more product/jars/vintage_jar_small_candle.png', extraImg: '../Assets/more product/jars/vintage_jar_small_lid.png' },
                { label: 'Large', capacity: '420g', price: 45, img: '../Assets/more product/jars/vintage_jar_big.png',   hoverImg: '../Assets/more product/jars/vintage_jar_big_candle.png',   extraImg: '../Assets/more product/jars/vintage_jar_big_lid.png' },
            ],
        },

        'aurora-jar': {
            id: 'aurora-jar', name: 'Aurora Jar', price: 30,
            category: 'jars', categoryLabel: 'Jar',
            ...
            sizes: [
                { label: 'Small', capacity: '230g', price: 30, img: '../Assets/more product/jars/crystal_jar_small.png', hoverImg: '../Assets/more product/jars/crystal_jar_small_candle.png' },
                { label: 'Large', capacity: '420g', price: 45, img: '../Assets/more product/jars/crystal_jar_big.png',   hoverImg: '../Assets/more product/jars/crystal_jar_big_candle.png' },
            ],
        },
    ...
    /* ======== Navigation ======== */
    document.getElementById('nav-shop-btn')?.addEventListener('click', event => { event.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); });
    document.getElementById('nav-build-btn')?.addEventListener('click', () => { window.location.href = '../build/build.html'; });
    document.getElementById('nav-about-btn')?.addEventListener('click', () => { window.location.href = '../about/about.html'; });
    document.getElementById('nav-contact-btn')?.addEventListener('click', () => { window.location.href = '../contact/contact.html'; });
    ...
    grid?.addEventListener('click', e => {
        // Event delegation: one listener handles every current/future Add to Cart button in the product grid.
    ...
    function addToCart({ id, name, price, image }) {
        ...
        if (existing) {
            ...
            cart.push({ id, name, price: numericPrice, image: image || '', qty: 1 });
        }
    ...
    qvAddToCart.addEventListener('click', () => {
        ...
        let finalImage = currentQvProduct.img;
        if (selectedColor) {
            finalName += ` (${selectedColor})`;
            finalImage = waxColorImages[selectedColor]?.bag || finalImage;
        }
        if (selectedSize) {
            finalName += ` (${selectedSize.label})`;
            finalPrice = selectedSize.price;
            finalImage = selectedSize.img || finalImage;
        }
        addToCart({ id: currentQvProduct.id, name: finalName, price: finalPrice, image: finalImage });
        updateCartBadge();
